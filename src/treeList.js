...
export class TreeList {
    constructor(barHeight, contextMenu) {
        console.log('TreeList constructor first');
        console.log('this[TreeList Constructor]: %o', this);
        ...
        console.log('TreeList constructor after update');
        this.scroll = scrollbar(barHeight)
            .onDrag(function() { update(); });
        console.log('TreeList constructor after scroll');
        this.width;
        this.height;
        console.log('this[TreeList Constructor]: %o', this);
        this.onChange;
        console.log('TreeList constructor after onChange');
        console.log('this[TreeList Constructor]: %o', this);
        this.nodes = [];
    ...
    onChange(fn) {
        console.log('TreeList[onChange]: %o', fn);
        if (arguments.length) {
            console.log('TreeList[onChnage]: %o', arguments);
            this._onChange = fn;
            return this;
        }
