...
export class RowRendererBit extends RowRendererBase {
    select (typeInfo) {
        return (typeInfo.name === 'wire' || typeInfo.name == 'real' || typeInfo.name == 'reg') && typeInfo.width === 1;
        // return (typeInfo.type === 'wire' || typeInfo.type == 'real'
        // || typeInfo.type == 'reg') && (typeInfo.size === 1);
    }
